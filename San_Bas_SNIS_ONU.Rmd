...
date: "`r format(Sys.Date(), '%d de %B de %Y')`"             # Adiciona a data atual automaticamente
output: 
  html_document:
    ...
    toc_float: 
      ...
      position: "left"      # Posição do índice flutuante
    theme: paper         # Tema Bootstrap para o HTML
    highlight: tango        # Destaca a sintaxe em R
