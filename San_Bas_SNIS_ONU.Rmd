...
output: 
  html_document:
    css: "estilo.css"
    includes:
      after_body: "footer.html" # Inclui o rodapé após o corpo do documento
---

<div style="display: flex; justify-content: space-between; width: 50%; padding: 10px;">
  <!-- Primeira imagem (no canto superior esquerdo) -->
  <img src="Imagens/logtipo_projeto2/logtipo_projeto_oficial.png" style="width: 45%; height: auto;"/>
