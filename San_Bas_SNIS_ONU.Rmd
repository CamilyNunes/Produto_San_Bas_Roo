...
Variáveis para usar no cálculo: populacao_total: A população total do município (variável com dados gerais). populacao_atendida_esgoto_tratado: A população que é atendida com esgoto tratado (variável específica para o serviço de esgoto).
