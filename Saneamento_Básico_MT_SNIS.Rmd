...
```{r}
#Converter as colunas para numérico, removendo possíveis caracteres  
san <- san %>%
  mutate(
    índice_tratamento_esgoto_percentual = coalesce(as.numeric(as.character(índice_tratamento_esgoto_percentual)), 
                                                    as.numeric(as.character(índice_tratamento_esgoto_percentual))),
    volume_esgoto_coletado_m3 = coalesce(as.numeric(as.character(volume_esgoto_coletado_m3)), 
                                          as.numeric(as.character(volume_esgoto_coletado_m3))),
    índice_coleta_esgoto = coalesce(as.numeric(as.character(índice_coleta_esgoto)), 
                                     as.numeric(as.character(índice_coleta_esgoto))),
    consumo_agua_percapita = coalesce(as.numeric(as.character(consumo_agua_percapita)), 
                                       as.numeric(as.character(consumo_agua_percapita)))
  )
```  
